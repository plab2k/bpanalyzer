...
app.db = (function () {
    ...
    return {
        ...
        init: function () {
            return new Promise(function (resolve, reject) {
                ...
                o.onupgradeneeded = function (e) {
                    ...
                    o.objectStoreNames.contains("task") || o.createObjectStore("task", {
                        autoIncrement: !0
        ...
        getTableNames: () => {
            ...
            return Array.from(_instance.objectStoreNames).filter(e => { return e[0] != "_" });
        },
        putData: (name, data) => {
            return new Promise((resolve, reject) => {
                ...
                const transaction = _instance.transaction(name, "readwrite");
